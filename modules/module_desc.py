...
class InputDesc(namedtuple('InputDescTuple', ['datatype', 'datashape', 'name'])):
    """
    ...
    def __new__(cls, datatype, datashape, name):
        ...
        self = super(InputDesc, cls).__new__(cls, datatype, datashape, name)
        return self


class OutputDesc(namedtuple('OutputDescTuple', ['datatype', 'datashape', 'name'])):
    """
    ...
    def __new__(cls, datatype, datashape, name):
        ...
        self = super(OutputDesc, cls).__new__(cls, datatype, datashape, name)
        return self
...
class ModuleDesc(object):
    ...
    def output_names(self):
        ...
        """
        return [k.name for k in self.get_outputs_desc()]
